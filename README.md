...
_Info: The current state of the software does not allow to configure the model. Therefore, the unconditional models can be only used to generate crystals randomly._  
...
_Info: The magnetic density range is provided from the [Material Explorer](https://next-gen.materialsproject.org/materials)._
...
_Info: The band gap range is provided from the [Material Explorer](https://next-gen.materialsproject.org/materials)._
...
_Info: The bulk modulus range is provided from the [Material Explorer](https://next-gen.materialsproject.org/materials)._
...
_Info: Higher HHI indicates lower competition and higher market concentration (monopoly-like structure). It is a measure of market structure, not physical scarcity, although scarcity can indirectly influence concentration through barriers to production._  
